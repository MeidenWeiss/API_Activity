...
<html>
    ...
    <body>
        <div id="navigation_body">                                   <!--NAVIGATION BAR-->
            <div class="navbar">
                <ul>
                    <li><a href="index.php?page=#"> Live Premiere </a></li>
                    <li><a href="index.php?page=#"> Coming Soon </a></li>
                    <li><a href="index.php?page=movies"> Movie Database </a></li>
                    <li><a href="index.php?page=#"> Schedules </a></li>
                </ul>
            </div>
        </div>
        <div>
